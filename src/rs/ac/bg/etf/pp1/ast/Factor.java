...
public class Factor implements SyntaxNode {
    ...
    private FactorX FactorX;

    public Factor (OptionalMinus OptionalMinus, FactorX FactorX) {
        this.OptionalMinus=OptionalMinus;
        if(OptionalMinus!=null) OptionalMinus.setParent(this);
        this.FactorX=FactorX;
        if(FactorX!=null) FactorX.setParent(this);
    }
    ...
    public FactorX getFactorX() {
        return FactorX;
    }

    public void setFactorX(FactorX FactorX) {
        this.FactorX=FactorX;
    }
    ...
    public String toString(String tab) {
        ...
        if(FactorX!=null)
            buffer.append(FactorX.toString("  "+tab));
        else
            buffer.append(tab+"  null");
        buffer.append("\n");
