...
public class InitListAdditional_exists extends InitListAdditional {

    private InitList InitList;

    public InitListAdditional_exists (InitList InitList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("InitListAdditional_exists(\n");
