...
public class ConVarDeclV extends ConstVarDeclList {

    private ConstVarDeclList ConstVarDeclList;
    private VarDeclList VarDeclList;

    public ConVarDeclV (ConstVarDeclList ConstVarDeclList, VarDeclList VarDeclList) {
